...
export function CartSummary() {
  ...
  const totalAmount = totalPrice! + shippingAmout
  ...
  async function onCheckout() {
    ...
    try {
      ...
      setLoading(false);
      // Handle the error or display a suitable message to the user
    }
  }
    ...
    >
      ...
      <dl className="mt-6 space-y-4">
        ...
        <div className="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600">
          ...
          <dd className="text-sm font-medium">{formatCurrencyString({ value : shippingAmout,
             currency: "TND" } )}</dd>
        </div>
        <div className="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600">
